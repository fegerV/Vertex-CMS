...
Route::name('admin.')->prefix('admin')->group(function (): void {
    ...
    Route::middleware(['auth', 'vertex.permission:admin.access', SetAdminLocale::class])->group(function (): void {
        ...
        Route::get('email-templates', [EmailTemplateController::class, 'index'])
            ->middleware('vertex.permission:mail.view')
            ->name('email-templates.index');
        Route::get('email-templates/create', [EmailTemplateController::class, 'create'])
            ->middleware('vertex.permission:mail.edit')
        ...
        Route::delete('email-logs/{log}', [EmailLogController::class, 'destroy'])
            ->middleware('vertex.permission:mail.delete')
            ->name('email-logs.destroy');
        Route::post('email-logs/{log}/resend', [EmailLogController::class, 'resend'])
            ->middleware('vertex.permission:mail.edit')
