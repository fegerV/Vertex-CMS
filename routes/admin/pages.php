...
Route::get("pages/builder/design-library", [AdvancedBuilderController::class, "designLibrary"])->middleware("vertex.permission:pages.edit")->name("pages.builder.design-library.index");
Route::get("api/pages/builder/design-library", [AdvancedBuilderController::class, "getDesignLibrary"])->middleware("vertex.permission:pages.edit")->name("pages.builder.design-library.api");
