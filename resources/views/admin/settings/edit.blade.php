...
@section('content')
    @php
        ...
        $sectionIcons = [
            ...
            'design' => '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3a9 9 0 100 18h1.5a1.5 1.5 0 000-3H12a1.5 1.5 0 010-3h2a7 7 0 000-12h-2z"></path></svg>',
                                    ...
                                    @foreach ($group['fields'] as $key => $field)
                                        ...
                                        @if ($fieldInput === 'textarea')
                                            ...
                                            @if (isset($field['description']))
                                                <p class="mt-1.5 text-[10px] text-[var(--vc-text-soft)] flex items-start gap-1">
                                                    ...
                                                    <span class="whitespace-pre-line">{{ $field['description'] }}</span>
                                                </p>
                                            @elseif ($fieldType === 'encrypted')
