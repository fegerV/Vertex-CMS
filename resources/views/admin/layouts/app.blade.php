        ...
        $navigation = [
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Design Library', 'route' => 'admin.pages.builder.design-library.index', 'active' => 'admin.pages.builder.design-library.*', 'permission' => 'pages.edit', 'description' => 'Шаблоны и пресеты Builder', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 6.75A2.25 2.25 0 0 1 6.75 4.5h10.5a2.25 2.25 0 0 1 2.25 2.25v10.5a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25V6.75Zm3 1.5h9m-9 3.75h9m-9 3.75h5.25" />'],
