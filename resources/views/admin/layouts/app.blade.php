...
<body class="bg-slate-100 text-slate-900 antialiased dark:bg-slate-900 dark:text-slate-100" x-data="{ sidebarOpen: false, sidebarCollapsed: false, searchOpen: false, userMenuOpen: false }" :class="{ 'sidebar-collapsed': sidebarCollapsed && !sidebarOpen }">
    ...
    <div class="min-h-screen lg:flex">
        ...
        >
            ...
            <!-- User info at bottom -->
            <div class="sidebar-user-info border-t border-slate-100 dark:border-slate-700 p-3" x-show="!sidebarCollapsed || sidebarOpen">
                <div class="flex items-center gap-2 rounded-lg bg-slate-50 dark:bg-slate-700 p-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white font-semibold text-xs flex-shrink-0">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            >
                                ...
                                <a href="{{ route('admin.settings.edit') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50">
