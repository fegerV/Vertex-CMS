            ...
            'mail' => [
                ...
                'fields' => [
                    ...
                    'mail.port' => [
                        ...
                        'description' => 'Обычно 25, 465 (SSL) или 587 (TLS)',
                    ],
                    'mail.encryption' => [
                        'label' => 'Шифрование',
                        'type' => 'string',
                    ...
                    'mail.test_recipient' => [
                        ...
                        'input' => 'email',
                        'rules' => ['nullable', 'email', 'max:255'],
                        'description' => 'Адрес для тестовой отправки',
                    ],
                    'mail.queue_enabled' => [
                        'label' => 'Использовать очередь',
                        'type' => 'boolean',
                        'input' => 'checkbox',
                        'rules' => ['nullable', 'boolean'],
                        'description' => 'Откладывать отправку в очередь mailer queue',
                    ],
                    'mail.retry_attempts' => [
                        'label' => 'Попытки при ошибке',
                        'type' => 'integer',
                        'input' => 'number',
                        'rules' => ['nullable', 'integer', 'min:1', 'max:10'],
                        'description' => 'Сколько раз повторить при ошибке отправки',
                    ],
                    'mail.log_all' => [
                        'label' => 'Логировать все письма',
                        'type' => 'boolean',
                        'input' => 'checkbox',
                        'rules' => ['nullable', 'boolean'],
                        'description' => 'Сохранять копию каждого письма в базе',
                    ],
                    'mail.attach_assets' => [
                        'label' => 'Встраивать вложения',
                        'type' => 'boolean',
                        'input' => 'checkbox',
                        'rules' => ['nullable', 'boolean'],
                        'description' => 'Автоматически встраивать изображения из body',
                    ],
                ],
            ],
];
